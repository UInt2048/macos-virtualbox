...
macOS_release_name="High Sierra" # install "HighSierra" "Mojave" or "Catalina"
storage_size=64000               # VM disk image size in MB, minimum 22000
...
gpu_vram=256                     # VM video RAM in MB, minimum 34, maximum 128
resolution="1920x1200"           # VM display resolution
...
DmiSystemProduct="MacBookPro16,2"    # Model Identifier
DmiSystemSerial="C02D1BEJML7H"       # Serial Number (system)
DmiSystemUuid="9B1FDA64-541C-5BBB-9BF4-21EAE72E651A" # Hardware UUID
DmiBIOSVersion="1554.40.33.0.0"      # Boot ROM Version
...
DmiBoardProduct="Mac-5F9802EFE386AA28"
#   nvram 4D1EDE05-38C7-4A6A-9CC6-4BCCA8B38C14:MLB
DmiBoardSerial="C02026608BBP9KP1K"    # stored in EFI
MLB="${DmiBoardSerial}"               # stored in NVRAM
#   nvram 4D1EDE05-38C7-4A6A-9CC6-4BCCA8B38C14:ROM
ROM='x%cdw^%01%a7'
#   ioreg -l -p IODeviceTree | grep \"system-id
SYSTEM_UUID="9c434ede07ace3558ada3b590a746b16"
#   csrutil status
